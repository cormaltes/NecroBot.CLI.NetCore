...
namespace PoGo.NecroBot.CLI
{
    internal class Program
    {
        ...
        private static void Main(string[] args)
        {
            ...
            string strCulture = System.Globalization.CultureInfo.CurrentCulture.TwoLetterISOLanguageName;
            ...
            if (boolNeedsSetup)
            {
                ...
                //{
                    ...
                    Logger.Write("Edit the configuration files in the Config directory \n Press a Key to continue...",
                        LogLevel.Warning);
                    Console.ReadKey();
                    return;
                //}
            ...
            */
            ...
            ProgressBar.fill(30);
            string strVersion = System.Reflection.Assembly.GetEntryAssembly().GetName().Version.ToString(3);
            stats.DirtyEvent +=
                () =>
        ...
        private static void UnhandledExceptionEventHandler(object obj, EventArgs args)
        {
